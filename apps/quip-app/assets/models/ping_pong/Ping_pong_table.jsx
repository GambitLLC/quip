...
Command: npx gltfjsx@6.2.10 ping_pong_table.glb
...
export function Model(props) {
  ...
  const materials = {
    green: new MeshStandardMaterial({metalness: 0.0, roughness: 0.8929713596497552, map: Texture0, side: 2}),
    aluminum: new MeshStandardMaterial({metalness: 0.0, roughness: 0.8929713596497552, map: Texture1, side: 2}),
    plastic: new MeshStandardMaterial({metalness: 0.0, roughness: 0.8929713596497552, map: Texture2, side: 2}),
    grey: new MeshStandardMaterial({metalness: 0.0, roughness: 0.8929713596497552, map: Texture3, side: 2}),
    fabric: new MeshStandardMaterial({metalness: 0.0, roughness: 0.8929713596497552, map: Texture4, side: 2}),
    yellow: new MeshStandardMaterial({metalness: 0.0, roughness: 0.8929713596497552, map: Texture5, side: 2}),
    paddle_ping_pong: new MeshStandardMaterial({metalness: 0.0, roughness: 0.6, side: 2}),
    material: new MeshStandardMaterial({metalness: 0.0, roughness: 0.8929713596497552, map: Texture6, side: 2}),
    caucho_rojo_p: new MeshStandardMaterial({metalness: 0.0, roughness: 0.6, side: 2}),
    caucho_negro_p: new MeshStandardMaterial({metalness: 0.0, roughness: 0.6, side: 2}),
    paddle_ping_pong_0: new MeshStandardMaterial({metalness: 0.0, roughness: 0.6, side: 2}),
    caucho_rojo_p_0: new MeshStandardMaterial({metalness: 0.0, roughness: 0.6, side: 2}),
    caucho_negro_p_0: new MeshStandardMaterial({metalness: 0.0, roughness: 0.6, side: 2}),
  }
